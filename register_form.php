...
<form action="registered.php" method="post" id="form1">
    <table width="850" border="0" cellpadding="5">
        ...
        <tr>
            ...
            <td width="200" style="color:grey; font-size:small;">At least 8 characters with combination of letters,
                numbers, and symbols</td>
        </tr>

        <tr>
            <td width="200">Confirm Password</td>
            <td width="300"><label for="cfm_pwd"></label>
                <input type="text" name="cfm_pwd" id="cfm_pwd" size="40" />
            </td>
        </tr>
